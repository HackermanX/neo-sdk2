...
public:
	...
	{
		memory::CallVFunc<void, int&, int&>(this, 5, iWidth, iHeight);
	}
	...
	{
		memory::CallVFunc<void, QAngle&>(this, 18, angView);
	}

	void SetViewAngles(QAngle* angView)
	{
		memory::CallVFunc<void, QAngle*>(this, 19, angView);
	}
	...
	{
		return memory::CallVFunc<INetChannel*>(this, 78);
	}
