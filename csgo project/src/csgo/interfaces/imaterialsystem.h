...
public:
	...
	bool& DisableRenderTargetAllocationForever()
	{
		...
		static auto uDisableRenderTargetAllocationForever = *reinterpret_cast<std::uintptr_t*>(memory::PatternScan(MATERIALSYSTEM_DLL, XorStr("80 B9 ? ? ? ? ? 74 0F")) + 0x2);
