...
public:
	...
	{
		memory::CallVFunc<void>(this, 11, bEnable);
	}

	bool IsButtonDown(EButtonCode buttonCode)
	{
		return memory::CallVFunc<bool>(this, 15, buttonCode);
	}
	...
	{
		return memory::CallVFunc<const char*>(this, 40, buttonCode);
	}

	EButtonCode VirtualKeyToButtonCode(int iVirtualKey)
	{
		return memory::CallVFunc<EButtonCode>(this, 45, iVirtualKey);
	}

	void GetCursorPosition(int* pX, int* pY)
	{
		memory::CallVFunc<void>(this, 56, pX, pY);
	}
};
