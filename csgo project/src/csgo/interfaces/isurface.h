...
public:
	...
	{
		memory::CallVFunc<void>(this, 14, color);
	}
	...
	{
		memory::CallVFunc<void>(this, 28, wText, nTextLength, drawType);
	}
	...
	void DrawClearApparentDepth()
	{
		return memory::CallVFunc<void>(this, 22);
	}

	void GetCursorPos(int& x, int& y) {
		using get_cursor_pos_fn = void(__thiscall*)(void*, int&, int&);
		memory::CallVFunc< get_cursor_pos_fn >(this, 100)(this, x, y);
	}
};