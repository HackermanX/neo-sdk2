...
public:
	...
	void SetAbsOrigin(Vector vecOrigin)
	{
		...
		static auto oSetAbsOrigin = reinterpret_cast<SetAbsOriginFn>(memory::PatternScan(CLIENT_DLL, XorStr("55 8B EC 83 E4 F8 51 53 56 57 8B F1 E8")));
	...
	void SetAbsAngles(QAngle angView)
	{
		...
		static auto oSetAbsAngles = reinterpret_cast<SetAbsAngleFn>(memory::PatternScan(CLIENT_DLL, XorStr("55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1 E8")));
